            ...
            <div id="content_2_4" style="width: 850px; margin: auto; margin-top: 30px;">
                ...
                <br>
                        ...
                        <div align="center" class="pagingArea">
                            ...
                            <% } else { %>
                                <% if(currentPage != 1) { %>
                                    <button class="btn btn-outline-secondary btn-sm" onclick="location.href='<%=contextPath%>/searchNotice.ad?currentPage=<%=currentPage-1%>&searchNoticeText=<%=searchNoticeText %>&searchNoticeCtg=<%=searchNoticeCtg%>';">이전</button>
                                <% } %>
                                ...
                                <% for(int p=startPage; p<=endPage; p++) { %>
                                    ...
                                    <% }else{ %>
                                        <button class="btn btn-outline-secondary btn-sm" onclick="location.href='<%=contextPath%>/searchNotice.ad?currentPage=<%= p %>&searchNoticeText=<%=searchNoticeText %>&searchNoticeCtg=<%=searchNoticeCtg%>';"><%= p %></button>
                                    <% } %>
                                    
                                <% } %>
                                
                                <% if(currentPage != maxPage){ %>
                                    <button class="btn btn-outline-secondary btn-sm" onclick="location.href='<%=contextPath%>/searchNotice.ad?currentPage=<%=currentPage+1%>&searchNoticeText=<%=searchNoticeText %>&searchNoticeCtg=<%=searchNoticeCtg%>';">다음</button>
                                <% } %>
                            <% } %>	
                        </div>
