        ...
        <div id="content">
            ...
            <div id="content_2_4" style="width: 850px; margin: auto; margin-top: 30px;">
                ...
                <div align="center" class="pagingArea">
                    ...
                    <% } else { %>
                        <% if(currentPage != 1) { %>
                            <button class="btn btn-outline-secondary btn-sm"  onclick="location.href='<%=contextPath%>/ctQuerySelect.ad?currentPage=<%=currentPage-1%>&reStatus=<%=list.get(0).getReplyStatus() %>';">이전</button>
                        <% } %>
                        ...
                        <% for(int p=startPage; p<=endPage; p++) { %>
                            ...
                            <% }else{ %>
                                <button class="btn btn-outline-secondary btn-sm" onclick="location.href='<%=contextPath%>/ctQuerySelect.ad?currentPage=<%= p %>&reStatus=<%=list.get(0).getReplyStatus() %>';"><%= p %></button>
                            <% } %>
                            
                        <% } %>
                        
                        <% if(currentPage != maxPage){ %>
                            <button class="btn btn-outline-secondary btn-sm" onclick="location.href='<%=contextPath%>/ctQuerySelect.ad?currentPage=<%=currentPage+1%>&reStatus=<%=list.get(0).getReplyStatus() %>';">다음</button>
                        <% } %>
                     <% } %>	
