                        ...
                        <div id="htEnroll">
                            ...
                            <table align="center">
                                <thead>
                                    <tr>
                                        <select name="category" id="category" required>
                                            <option name="category" value="0" selected >선택</option>
                                            <option name="category" value="whole" >전신운동</option>
                                            <option name="category" value="core">코어운동</option>
                                            <option name="category" value="upper">상체운동</option>
                                            <option name="category" value="lower">하체운동</option>
                                            <option name="category" value="stretching">스트레칭</option>
                                        </select>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>썸네일 선택</th>
                                        <td><input type="file" name="upfile" name="upfile" id="upfile" onchange="loadImg(this, 1);" required></td>
                                    </tr>
