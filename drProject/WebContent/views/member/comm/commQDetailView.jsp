        ...
        <div id="content">
            ...
            <div id="content_2">
                ...
                <div class="buttonArea1" align="right">
                    <a href="<%=contextPath%>/qUpdateForm.co?cno=<%=c.getCommPostNo()%>">수정</a>
	                <a href="<%=contextPath%>/qDelete.co?cno=<%=c.getCommPostNo()%>">삭제</a>
                </div><br><br>
                <% } %>
                ...
                <div class="buttonArea3" align="right">
	                ...
	                <a href="<%=contextPath%>/question.co?currentPage=1">목록</a>
                </div><br><br>
