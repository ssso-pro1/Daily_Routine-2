            ...
            <div id="content_2">
                ...
                <div id="content_2_2">
                    <div class="enrollArea">
                       <form action="<%=contextPath%>/qInsert.co" id="enrollForm" method="post" enctype="multipart/form-data">
                            <table>
                                <tr>
                                    <table>
                                        <tr>
                                        ...
                                        <tr>
                                            <td height="500">
                                                <textarea class="summernote" name="qContent" id="qContent" rows="20" style="resize:none" placeholder="내용을 입력해주세요." required></textarea>   
                                            </td>
                                        </tr>
                                    </table>
                                </tr>
