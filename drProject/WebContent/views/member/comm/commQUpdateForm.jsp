                                    ...
                                    <table>
                                            ...
                                            <table>
                                                <tr>
                                                    <td width="800" height="30">
                                                        <input type="file" name="reUpfile" id="reUpfile" style="cursor:pointer;"> 
                                                   		<!-- 기존의 첨부파일이 있었다면 -->
                                                        <% if(cf != null) { %>
                                                            <%=cf.getFileName() %>
                                        ...
                                        <tr>
                                            <td colspan="2" height="500">
                                                <textarea class="summernote" name="qContent" id="qContent" rows="20" style="resize:none" required><%=c.getPostContent()%></textarea>   
                                            </td>
                                        </tr>
                                    </table>
                                </tr>
