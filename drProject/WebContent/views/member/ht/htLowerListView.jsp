		...
		<div id="content">
			<div id="content_1">
                ...
                <div class="leftMenu">
                    ...
                    <br>
                    <div><a href="<%=contextPath%>/lowerList.ht?currentPage=1" style="color:rgb(250, 214, 9);">하체 운동</a></div>
                    <br>
            ...
            <div id="content_2">
                ...
                <!-- 상단 타이틀-->
                <div id="content2_1">
                    <h2>HomeTraining > 하체 운동</h2>
                    <hr>
                    <p>홈트레이닝 하체 운동 조회입니다.</p>
                </div>
                <br><br>
				<div id="content_2_2">
					...
					<div align="center" class="pagingArea">
						<% if(currentPage != 1){ %>
							<button onclick="location.href='<%= contextPath %>/lowerList.ht?currentPage=<%= currentPage-1 %>';"><</button>
						<% } %>
						...
						<% for(int p=startPage; p<=endPage; p++){ %>
							...
							<% }else{ %>
								<button onclick="location.href='<%= contextPath %>/lowerList.ht?currentPage=<%= p %>';"><%= p %></button>
							<% } %>
						<% } %>
