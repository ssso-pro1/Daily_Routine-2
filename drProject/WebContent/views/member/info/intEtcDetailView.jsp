        ...
        <div id="content">
            ...
            <div id="content_2">
                ...
                <div id="content_2_1">
                    <h2>Info & Tip > 기타 팁 </h2>
                    <hr>
                    <p style="text-align:left;">Daily Routine에서 제공하는 다양한 팁을 참고해보세요!</p>
                </div>
                <br>
                    ...
                    <div class="detailArea">
                        <table border="0">
                            ...
                            <tr>
                                <td height="200"> 
                                    <p>
                                        <b style="font-size:15px;">기타 Tip 부제목</b> <br><br>
                                        * 추천 대상 <br>
                                        * 추천 대상 <br>
                                        * 추천 대상 <br><br><br>
                                        
                                        <b style="font-size:15px;""># 팁 내용 </b> <br><br>
                                        팁 내용 설명 <br>
                                        팁 내용 설명 <br>
                                        팁 내용 설명 <br>
                                        팁 내용 설명 <br>
