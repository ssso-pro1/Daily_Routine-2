        ...
        <div id="content">
            ...
            <div id="content_2">
                ...
                <div id="content_2_1">
                    ...
                    <hr>
                    <p style="text-align:left;">Daily Routine에서 제공하는 다양한 운동 루틴을 따라해보세요!</p>
                </div>
                <br>
                    ...
                    <div class="detailArea">
                        <table border="0">
                            ...
                            <tr>
                                <td height="200"> 
                                    <p>
                                        <b style="font-size:15px;">운동 루틴 </b> <br><br>
                                        * 추천 대상 <br>
                                        * 추천 대상 <br>
                                        * 추천 대상 <br><br><br>
                                        
                                        <b style="font-size:15px;""> 운동 루틴 내용 </b> <br><br>
                                        운동 루틴 설명 <br>
                                        운동 루틴 설명 <br>
                                        운동 루틴 설명 <br>
                                        운동 루틴 설명 <br>
