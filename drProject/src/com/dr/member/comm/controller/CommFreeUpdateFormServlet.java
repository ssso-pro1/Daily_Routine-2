...
/**
 * Servlet implementation class CommFreeUpdateFormServlet
 */
@WebServlet("/freeUpdateForm.co")
public class CommFreeUpdateFormServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CommFreeUpdateFormServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/member/comm/commFreeUpdateForm.jsp").forward(request, response); 
