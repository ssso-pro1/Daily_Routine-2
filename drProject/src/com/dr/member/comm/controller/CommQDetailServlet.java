...
/**
 * Servlet implementation class CommQDetailServlet
 */
@WebServlet("/qDetail.co")
public class CommQDetailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CommQDetailServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result > 0) { // 유효한 게시글 => 게시글, 첨부파일 조회 => 상세보기 페이지 
			...
			request.getRequestDispatcher("views/member/comm/commQDetailView.jsp").forward(request, response);
