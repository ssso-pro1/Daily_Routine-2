...
/**
 * Servlet implementation class CommTipDeleteServlet
 */
@WebServlet("/tipDelete.co")
public class CommTipDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CommTipDeleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			if(result > 0) {
				...
				response.sendRedirect(request.getContextPath() + "/commMain.co"); 
