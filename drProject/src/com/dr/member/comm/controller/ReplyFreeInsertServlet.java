...
/**
 * Servlet implementation class ReplyFreeInsertServlet
 */
@WebServlet("/replyFreeInsert.co")
public class ReplyFreeInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReplyFreeInsertServlet() {
        super();
