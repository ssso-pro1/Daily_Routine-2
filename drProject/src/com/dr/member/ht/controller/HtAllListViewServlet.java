 ...
 */
@WebServlet("/allList.ht")
public class HtAllListViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HtAllListViewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 페이징 처리
				...
				request.getRequestDispatcher("views/member/ht/htAllListView.jsp").forward(request, response);
