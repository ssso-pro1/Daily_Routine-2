 ...
 */
@WebServlet("/lowerList.ht")
public class HtLowerListViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HtLowerListViewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/member/ht/htLowerListView.jsp").forward(request, response);
