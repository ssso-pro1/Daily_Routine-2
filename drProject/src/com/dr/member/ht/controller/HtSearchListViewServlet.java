 ...
 */
@WebServlet("/searchList.ht")
public class HtSearchListViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HtSearchListViewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 페이징 처리
				...
				request.getRequestDispatcher("views/member/ht/htSearchListView.jsp").forward(request, response);
