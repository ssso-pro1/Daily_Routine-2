 ...
 */
@WebServlet("/strechingList.ht")
public class HtStrechingListViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HtStrechingListViewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/member/ht/htStrechingListView.jsp").forward(request, response);
	}
