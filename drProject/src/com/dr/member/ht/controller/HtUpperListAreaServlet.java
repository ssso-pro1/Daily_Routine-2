...
/**
 * Servlet implementation class HtUpperListViewServlet
 */
@WebServlet("/upperListArea.ht")
public class HtUpperListAreaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HtUpperListAreaServlet() {
        super();
