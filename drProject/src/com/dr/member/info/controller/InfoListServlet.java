...
public class InfoListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new InfoService().infoMainSelectListCount(); 
		...
		ArrayList<Info> list = new InfoService().infoMainSelectList(pi);
				
		request.setAttribute("pi", pi);
		request.setAttribute("list", list);
				
		request.getRequestDispatcher("views/member/info/infoMainListView.jsp").forward(request, response);
