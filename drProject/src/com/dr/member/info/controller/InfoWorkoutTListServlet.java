...
/**
 * Servlet implementation class InfoWorkoutListServlet
 */
@WebServlet("/workout.in")
public class InfoWorkoutTListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InfoWorkoutTListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new InfoService().workoutSelectListCount(); 
		...
		ArrayList<Info> list = new InfoService().workoutSelectThumbnailList(pi);
						
		request.setAttribute("pi", pi);
		request.setAttribute("list", list);
						
		request.getRequestDispatcher("views/member/info/infoWorkoutTListView.jsp").forward(request, response);
