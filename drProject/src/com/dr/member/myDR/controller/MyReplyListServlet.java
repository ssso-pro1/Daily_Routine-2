...
/**
 * Servlet implementation class MyReplyListServlet
 */
@WebServlet("/replyList.md")
public class MyReplyListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// listCount : 총 댓글 갯수 조회해서 담기
		replyListCount = new MyDrService().selectMyReplyListCount(userNo);
		...
		PageInfo pi = new PageInfo(replyListCount, currentPage, pageLimit, boardLimit, maxPage, startPage, endPage);
		...
		request.getRequestDispatcher("views/member/myDR/myReplyList.jsp").forward(request, response);
	}
