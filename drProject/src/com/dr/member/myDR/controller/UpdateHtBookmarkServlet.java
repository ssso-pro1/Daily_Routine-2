...
/**
 * Servlet implementation class UpdateHtBookmarkServlet
 */
@WebServlet("/updateHtBookmark.md")
public class UpdateHtBookmarkServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateHtBookmarkServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/member/myDR/htBookmarkListUpdate.jsp").forward(request, response);
	}
