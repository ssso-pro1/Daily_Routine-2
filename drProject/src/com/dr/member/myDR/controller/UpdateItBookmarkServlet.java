 ...
 */
@WebServlet("/updateItBookmark.md")
public class UpdateItBookmarkServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateItBookmarkServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/member/myDR/itBookmarkListUpdate.jsp").forward(request, response);
	}
